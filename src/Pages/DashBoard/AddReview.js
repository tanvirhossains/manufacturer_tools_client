...
const AddReview = () => {
    ...
    const onSubmit = data => {
        // const opinion = data.description
    ...
    return (
        ...
        "tool":"Shovel",
        "customerReview": "This is useful for the mechanic purpose and most of the time we use to reduce the more task and very useful",
        "date": "24 may 22",
        "img": "https://i.ibb.co/zQHDzk9/tanvir-1.jpg"
    }, */}
            ...
            <form action="" className='grid grid-cols-1 ' onSubmit={handleSubmit(onSubmit)}>
                ...
                />
                {errors.date?.type === 'required' && <p className='text-red-500 font-bold'>Please give Your tool Name !!</p>}
                <label className='label'>
                ...
                {errors.description?.type === 'required' && <p className='text-red-500 font-bold'>Please give Your Review </p>}
